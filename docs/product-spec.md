...
See [operating-model-alignment.md](./operating-model-alignment.md) and slice commitments in [roadmap.md](./roadmap.md).
...
SteerCo builds on three complementary sources (full backlog and vocabulary bridge in [operating-model-alignment.md](./operating-model-alignment.md)):
