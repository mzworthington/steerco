...
cp "$DP/mark-lockup.svg" "$PUB/assets/logo-lockup.svg"
...
rsvg-convert -w 332 -h 200 "$DP/mark-lockup.svg" -o "$PUB/assets/logo-lockup.png"
...
rsvg-convert -w 332 -h 200 "$DP/mark-lockup.svg" -o "$DP/mark-lockup.png"
